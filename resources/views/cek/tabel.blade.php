            ...
            <form action="{{ route('cek.filter') }}" method="GET" class="d-flex align-items-center" role="search">
                ...
                <div class="col-md-3">
                    ...
                    <a href="{{ route('cek.export', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}"
                        class="btn btn-success"><i class="bi bi-download"></i> Export</a>
                </div>
            </form>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive mt-3">
                <table class="table table-sm text-center">
                    ...
                    <tbody>
                        <?php $realNumber = ($cek->currentPage() - 1) * $cek->perPage(); ?> @foreach ($cek as $data)
                            <tr>
            ...
            <div class="card-footer">{{ $cek->links('pagination::bootstrap-4') }}</div>
        </div>
    </div>
@endsection
