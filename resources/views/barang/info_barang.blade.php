...
@section('container')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            {{-- Search --}}
            <form action="{{ route('barang.info_barang') }}" method="GET" class="d-flex align-items-center" role="search">
                <div class="col-md-6">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive mt-3">
                <table class="table table-sm text-center">
                    ...
                    <tbody>
                        <?php $realNumber = ($barang->currentPage() - 1) * $barang->perPage(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        {{-- Edit --}}
                                        <a href="{{ route('barang.edit_barang', $data->id_perangkat) }}"
                                        ...
                                        <div class="mx-1"></div>
                                        {{-- Delete --}}
                                        <form action="{{ route('barang.destroy', $data->id_perangkat) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
